(function () {
  ...
  var STORAGE_KEY = 'prometheus_exam_progress';
  var CHAPTER_STORAGE_KEY = 'prometheus_chapter_progress';
  ...
  var CHAPTERS = [
    { id: '01-observability-concepts',            title: 'Ch 1: Observability Fundamentals',         number: 1,  section: 'Observability Concepts' },
    { id: '02-metrics-logs-traces',                title: 'Ch 2: Metrics, Logs & Traces',             number: 2,  section: 'Observability Concepts' },
    { id: '03-prometheus-vs-other-tools',          title: 'Ch 3: Prometheus vs Other Tools',          number: 3,  section: 'Observability Concepts' },
    { id: '04-prometheus-architecture',            title: 'Ch 4: Prometheus Architecture',            number: 4,  section: 'Prometheus Fundamentals' },
    { id: '05-installation-configuration',         title: 'Ch 5: Installation & Configuration',       number: 5,  section: 'Prometheus Fundamentals' },
    { id: '06-data-model-metric-types',            title: 'Ch 6: Data Model & Metric Types',          number: 6,  section: 'Prometheus Fundamentals' },
    { id: '07-service-discovery-scraping',         title: 'Ch 7: Service Discovery & Scraping',       number: 7,  section: 'Prometheus Fundamentals' },
    { id: '08-storage-retention',                  title: 'Ch 8: Storage & Retention',                number: 8,  section: 'Prometheus Fundamentals' },
    { id: '09-promql-basics',                      title: 'Ch 9: PromQL Basics',                      number: 9,  section: 'PromQL' },
    { id: '10-promql-operators',                   title: 'Ch 10: PromQL Operators',                  number: 10, section: 'PromQL' },
    { id: '11-promql-functions',                   title: 'Ch 11: PromQL Functions',                  number: 11, section: 'PromQL' },
    { id: '12-advanced-promql',                    title: 'Ch 12: Advanced PromQL',                   number: 12, section: 'PromQL' },
    { id: '13-promql-practice-worksheet',          title: 'Ch 13: PromQL Practice Worksheet',         number: 13, section: 'PromQL' },
    { id: '14-client-libraries-instrumentation',   title: 'Ch 14: Client Libraries & Instrumentation', number: 14, section: 'Instrumentation & Exporters' },
    { id: '15-exporters',                          title: 'Ch 15: Exporters',                         number: 15, section: 'Instrumentation & Exporters' },
    { id: '16-pushgateway',                        title: 'Ch 16: Pushgateway & Short-Lived Jobs',     number: 16, section: 'Instrumentation & Exporters' },
    { id: '17-alerting-rules',                     title: 'Ch 17: Alerting Rules & Alertmanager',      number: 17, section: 'Alerting & Dashboarding' },
    { id: '18-alertmanager-routing',               title: 'Ch 18: Alertmanager Routing',               number: 18, section: 'Alerting & Dashboarding' },
    { id: '19-grafana-dashboards',                 title: 'Ch 19: Grafana Dashboards',                 number: 19, section: 'Alerting & Dashboarding' },
    { id: '20-practice-tests',                     title: 'Ch 20: Practice Tests Overview',            number: 20, section: 'Exam Prep' },
    { id: '21-interview-questions',                title: 'Ch 21: Interview Questions & Scenarios',    number: 21, section: 'Exam Prep' }
  ];
  ...
  function buildDashboardHTML() {
    var chStats = getChapterStats();
    var testStats = { completed: getTestCompletionCount(), total: getTotalTests() };
    ...
    html += '  <p class="exam-progress-summary">Track your Prometheus learning journey — from fundamentals to practice exams</p>';
    html += '</div>';
    ...
    var sections = ['Observability Concepts', 'Prometheus Fundamentals', 'PromQL', 'Instrumentation & Exporters', 'Alerting & Dashboarding', 'Exam Prep'];
    ...
    TESTS.forEach(function (t) {
      ...
      html += '    <p>60 questions across all 5 domains | 90 min</p>';
      ...
      html += '    </div>';
      html += '    <a href="/docs/' + (28 + t.number) + '-exam-practice-test-' + t.number + '/" style="display:inline-block;margin-top:0.75rem;font-size:0.85rem;">→ Open test</a>';
      html += '  </div>';
    });
